...
public class QuestionModel implements Serializable{
    public QuestionModel(Long id, byte[] image, String var1, String var2, String var3, String var4, long timeForAnswer, short correctAnswer, Theme theme, Cost cost,String text) {
        this.id = id;
        this.image = image;
        this.var1 = var1;
        this.var2 = var2;
